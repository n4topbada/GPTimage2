...
function isGalleryVisibleItem(item: { canvasVersion?: boolean; kind?: string | null }): boolean {
  return !item.canvasVersion && item.kind !== "card-news-set" && item.kind !== "card-news-card";
}
